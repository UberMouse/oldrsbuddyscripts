...
public class Equipable
{
    ...
    public int getEquipmentIndex() {
        switch (item.location()) {
            case HELM:
                return UberEquipment.HELMET;
            case CHEST:
                return UberEquipment.BODY;
            case LEGS:
                return UberEquipment.LEGS;
            case HANDS:
                return UberEquipment.HANDS;
            case FEET:
                return UberEquipment.FEET;
            case OFFHAND:
                return UberEquipment.SHIELD;
            case WEAPON:
                return UberEquipment.WEAPON;
            case AMMO:
                return UberEquipment.AMMO;
            default:
                return -1;
        }
    }
