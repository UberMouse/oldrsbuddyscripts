...
public class Maze extends PuzzlePlugin
{
    ...
    public int loop() {
        ...
        //        GameObject chest = UberPlayer.currentRoom()
        //                                   .getNearestObject(49345, 49346, 49347, 49348, 49349, 49350, 54407, 54408);
        //        GameObject lever = UberPlayer.currentRoom().getNearestObject(49351, 49352, 49353, 54409);
        //        Tile hT = null;
        ...
        //            mX = 1;
        //            mY = 1;
        //            hT = UberPlayer.currentRoom().getArea().getNearestTile(ORIGIN);
        //        }
        //        if (cTile.getX() - sTile.getX() > 4) {
        //            mX = -1;
        //            mY = -1;
        //            hT = UberPlayer.currentRoom().getArea().getNearestTile(new Tile(20000, 20000));
        //        }
        //        if (cTile.getY() - sTile.getY() < -4) {
        //            mX = -1;
        //            mY = 1;
        //            hT = UberPlayer.currentRoom().getArea().getNearestTile(new Tile(20000, 0));
        //            NS = true;
        //        }
        //        if (cTile.getY() - sTile.getY() > 4) {
        //            mX = 1;
        //            mY = -1;
        //            hT = UberPlayer.currentRoom().getArea().getNearestTile(new Tile(0, 20000));
        //            NS = true;
        //        }
        //        int hX = 0, hY = 0;
        //        if (hT == null)
        ...
        //        else
        //            return -1;
        //        while (UberPlayer.currentRoom().getNearestObject(FINISHED_CHESTS) == null && !mazeActive) {
        //            Objects.getTopAt(sTile).interact("Pull");
        //        }
        //        mazeActive = false;
        //        while (UberPlayer.currentRoom().getNearestObject(FINISHED_CHESTS) == null &&
        //               UberPlayer.currentRoom().contains(UberPlayer.location())) {
        ...
        //                }
        //            }
        //            GameObject closedChest = UberPlayer.currentRoom().getNearestObject(49345, 49346, 49347, 54407);
        //            if (closedChest != null && Calculations.distanceTo(closedChest) < 3) {
        //                while (UberPlayer.currentRoom().getNearestObject(49345, 49346, 49347, 54407) != null) {
        //                    if (isDead()) {
        //                        teleBack();
        //                    }
        //                    else if (failSafe()) {
        //                        return -1;
        //                    }
        //                    doObjAction(UberPlayer.currentRoom().getNearestObject(49345, 49346, 49347, 54407), "Open");
        //                    waitToStop(false);
        //                }
        //                getKey();
        //                if (nearItem != null) {
