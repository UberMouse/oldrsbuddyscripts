...
import nz.uberutils.irc.actions.Action;
import nz.uberutils.irc.actions.Join;
import nz.uberutils.irc.actions.Nick;
import nz.uberutils.irc.actions.Reconnect;
import nz.uberutils.irc.gui.Gui;
import nz.uberutils.irc.pircbot.IrcException;
import nz.uberutils.irc.pircbot.NickAlreadyInUseException;
import nz.uberutils.irc.pircbot.PircBot;
import nz.uberutils.irc.pircbot.User;
...
public class Client extends PircBot
{
    ...
    public Client(String server, String channel, String name) throws IOException, IrcException {
        ...
        setName(this.name.replaceAll(" ", "_"));
