...
package nz.uberutils.irc.pircbot;
...
public abstract class PircBot implements ReplyConstants
{
     ...
     * @throws nz.uberutils.irc.pircbot.IrcException              if the server would not let us join it.
     * @throws nz.uberutils.irc.pircbot.NickAlreadyInUseException if our nick is already in use on the server.
     */
     ...
     * @see nz.uberutils.irc.pircbot.Colors
     */
     ...
     * @see nz.uberutils.irc.pircbot.DccFileTransfer
     * @since 0.9c
     */
     ...
     *
     * @deprecated As of PircBot 1.2.0, use {@link #onIncomingFileTransfer(nz.uberutils.irc.pircbot.DccFileTransfer)}
     */
...
//            Gui.instance().addContentText(Color.GREEN, line + "\n");
     ...
     * @param code     The three-digit numerical code for the response.
     * @param response The full response from the IRC server.
     * @see nz.uberutils.irc.pircbot.ReplyConstants
     */
     ...
     * @see nz.uberutils.irc.pircbot.User
     * @since PircBot 1.0.0
     */
     ...
     *         in the channel.
     * @see #onUserList(String, nz.uberutils.irc.pircbot.User[]) onUserList
     * @since PircBot 1.0.0
     */
